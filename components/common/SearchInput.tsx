...
const SearchInput = ({ otherClasses, iconClasses }: TSearchInput) => {
  return (
    ...
    <Form action='/search' className="relative w-full z-10">
      ...
      <input
        type="text"
        className={`bg-background-secondary-color dark:bg-background-dark-secondary-color py-3 px-4 rounded-lg w-full text-md text-light-color tracking-widest focus:outline-none focus:border-none ${otherClasses}`}
