...
const FormButton: React.FC<TFormButton> = ({ isPending, title }) => {
  return (
    <button
      className="bg-gradient-to-r bg-primary text-white font-bold py-2 px-4 rounded-md mt-4 hover:bg-primary/70 transition ease-in-out duration-150 relative min-h-[40px]" // Adds minimum height for consistent button dimensions.
