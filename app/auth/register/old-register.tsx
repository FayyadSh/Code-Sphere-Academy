        ...
        <div className="w-full max-w-md bg-background-color dark:bg-background-dark-color shadow-sm rounded-lg p-6">
          ...
          <form className="flex flex-col" onSubmit={handleRegister}>
            ...
            <div className="flex space-x-4 mb-2">
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="bg-background-secondary-color dark:bg-background-dark-secondary-color text-light-color/65 w-full border-0 rounded-md p-2 focus:outline-none focus:ring-1 focus:ring-primary transition ease-in-out duration-150"
                  type="text"
                  value={firstName}
                  required
                />
            ...
            <input
              ...
              className="bg-background-secondary-color dark:bg-background-dark-secondary-color text-light-color/65 border-0 rounded-md p-2 mb-2 focus:outline-none focus:ring-1 focus:ring-primary transition ease-in-out duration-150"
              type="email"
              value={email}
              required
            />
            ...
            <input
              ...
              className="bg-background-secondary-color dark:bg-background-dark-secondary-color text-light-color/65 border-0 rounded-md p-2 mb-4 focus:outline-none focus:ring-1 focus:ring-primary transition ease-in-out duration-150"
              type="password"
            ...
            <FormButton title="Sign Up" isPending={loading} />
          </form>
